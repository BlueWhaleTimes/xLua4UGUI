...
//                ToLuaMenu.CopyLuaBytesFiles(srcDirs[i], streamDir);
    ...
    /// 处理热更新资源
    /// </summary>
	static void HandleHotUpdateBundle() {
        string resPath = AppDataPath + "/" + AppConst.AssetDir + "/";
        if (!Directory.Exists(resPath)) Directory.CreateDirectory(resPath);

        AddBuildMap("activity" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/HotUpdate/Prefabs/Activity");

		AddBuildMap("activity_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/HotUpdate/Textures/Activity");
    }
